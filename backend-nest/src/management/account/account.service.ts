...
export class AccountService {
    ...
    async findOne(id: number) {
        return (await this.repo
            ...
            .leftJoinAndMapOne('parentChild.person',PersonEntity,'parentPerson','parentChild.personId=parentPerson.id')
            .leftJoinAndMapOne('teacherChild.person',PersonEntity,'teacherPerson','teacherChild.personId=teacherPerson.id')
